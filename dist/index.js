module.exports = (function (e, t) {
  ...
  102: function (e, t, n) {
    ...
    var o =
      ...
      function (e) {
        ...
        if (e != null)
          for (var n in e)
            if (n !== "default" && Object.hasOwnProperty.call(e, n)) r(t, e, n);
        i(t, e);
        return t;
      };
    Object.defineProperty(t, "__esModule", { value: true });
    ...
    function issueCommand(e, t) {
      ...
      s.appendFileSync(n, `${u.toCommandValue(t)}${a.EOL}`, {
        encoding: "utf8",
      });
    }
  ...
  104: function (e, t, n) {
    const { createBadgeFromInputs: r } = n(392);
    r();
  },
  207: function (e) {
    e.exports = {
  ...
  295: function (e, n) {
    let i = Object.defineProperty,
      ...
      s = (e) => i(e, "__esModule", { value: !0 }),
      a = (e, t) => {
        s(e);
        for (let n in t) i(e, n, { get: t[n], enumerable: !0 });
      };
    var l = o((e, t) => {
      t.exports = [
      ...
      f = (e) => {
        ...
        return ([...n]) => {
          let r = 0,
            i = 0,
            o = n.length;
          for (; o--; ) (i = e[n[o].charCodeAt()]), (r += i === void 0 ? t : i);
          return r;
        };
      },
      d = f(c);
    ...
    function t({
      ...
      u(typeof n === "string", "<status> must be string"),
        (e = e === void 0 ? t : e);
      if (!e && !s) return B({ status: n, color: i, style: o });
      (i = p[i] || i), (l = p[l] || l), (a = a * 10);
      const f = s ? (e.length ? a + 30 : a - 18) : 0,
        g = s ? f + 50 : 50,
        h = d(e),
        x = d(n),
        m = h + 100 + f,
        $ = x + 100,
        y = m + $,
        b = s ? ' xmlns:xlink="http://www.w3.org/1999/xlink"' : "";
      (e = r(e)), (n = r(n));
      const w = C({ label: e, status: n });
      return o === "flat"
        ? `<svg width="${(c * y) / 10}" height="${
            c * 20
          }" viewBox="0 0 ${y} 200" xmlns="http://www.w3.org/2000/svg"${b} role="img" aria-label="${w}">\n  <title>${w}</title>\n  <g>\n    <rect fill="#${l}" width="${m}" height="200"/>\n    <rect fill="#${i}" x="${m}" width="${$}" height="200"/>\n  </g>\n  <g aria-hidden="true" fill="#fff" text-anchor="start" font-family="Verdana,DejaVu Sans,sans-serif" font-size="110">\n    <text x="${
            g + 10
          }" y="148" textLength="${h}" fill="#000" opacity="0.1">${e}</text>\n    <text x="${g}" y="138" textLength="${h}">${e}</text>\n    <text x="${
            m + 55
          }" y="148" textLength="${x}" fill="#000" opacity="0.1">${n}</text>\n    <text x="${
            m + 45
          }" y="138" textLength="${x}">${n}</text>\n  </g>\n  ${
            s
              ? `<image x="40" y="35" width="${a}" height="132" xlink:href="${s}"/>`
              : ""
          }\n</svg>`
        : `<svg width="${(c * y) / 10}" height="${
            c * 20
          }" viewBox="0 0 ${y} 200" xmlns="http://www.w3.org/2000/svg"${b} role="img" aria-label="${w}">\n  <title>${w}</title>\n  <linearGradient id="a" x2="0" y2="100%">\n    <stop offset="0" stop-opacity=".1" stop-color="#EEE"/>\n    <stop offset="1" stop-opacity=".1"/>\n  </linearGradient>\n  <mask id="m"><rect width="${y}" height="200" rx="30" fill="#FFF"/></mask>\n  <g mask="url(#m)">\n    <rect width="${m}" height="200" fill="#${l}"/>\n    <rect width="${$}" height="200" fill="#${i}" x="${m}"/>\n    <rect width="${y}" height="200" fill="url(#a)"/>\n  </g>\n  <g aria-hidden="true" fill="#fff" text-anchor="start" font-family="Verdana,DejaVu Sans,sans-serif" font-size="110">\n    <text x="${
            g + 10
          }" y="148" textLength="${h}" fill="#000" opacity="0.25">${e}</text>\n    <text x="${g}" y="138" textLength="${h}">${e}</text>\n    <text x="${
            m + 55
          }" y="148" textLength="${x}" fill="#000" opacity="0.25">${n}</text>\n    <text x="${
            m + 45
          }" y="138" textLength="${x}">${n}</text>\n  </g>\n  ${
            s
              ? `<image x="40" y="35" width="${a}" height="130" xlink:href="${s}"/>`
              : ""
          }\n</svg>`;
    }
    function B({ status: e, color: t, style: n }) {
      u(typeof e === "string", "<status> must be string"),
        (t = p[t] || t || p.blue);
      const i = d(e),
        o = i + 115;
      return (
        ...
        n === "flat"
          ? `<svg width="${
              o / 10
            }" height="20" viewBox="0 0 ${o} 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="${e}">\n  <title>${e}</title>\n  <g>\n    <rect fill="#${t}" x="0" width="${o}" height="200"/>\n  </g>\n  <g aria-hidden="true" fill="#fff" text-anchor="start" font-family="Verdana,DejaVu Sans,sans-serif" font-size="110">\n    <text x="65" y="148" textLength="${i}" fill="#000" opacity="0.1">${e}</text>\n    <text x="55" y="138" textLength="${i}">${e}</text>\n  </g>\n</svg>`
          : `<svg width="${
              o / 10
            }" height="20" viewBox="0 0 ${o} 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="${e}">\n  <title>${e}</title>\n  <linearGradient id="a" x2="0" y2="100%">\n    <stop offset="0" stop-opacity=".1" stop-color="#EEE"/>\n    <stop offset="1" stop-opacity=".1"/>\n  </linearGradient>\n  <mask id="m"><rect width="${o}" height="200" rx="30" fill="#FFF"/></mask>\n  <g mask="url(#m)">\n    <rect width="${o}" height="200" fill="#${t}" x="0"/>\n    <rect width="${o}" height="200" fill="url(#a)"/>\n  </g>\n  <g aria-hidden="true" fill="#fff" text-anchor="start" font-family="Verdana,DejaVu Sans,sans-serif" font-size="110">\n    <text x="65" y="148" textLength="${i}" fill="#000" opacity="0.25">${e}</text>\n    <text x="55" y="138" textLength="${i}">${e}</text>\n  </g>\n</svg>`
      );
    }
    function r(e) {
      return e
    ...
    typeof window === "object" && (window.badgen = t);
  },
  392: function (e, t, n) {
    var r = n(470),
      i = n(393),
    ...
    const f = {
      ...
      d = {
        status: ({ status: e }) => `${e}`,
        icon: ({ icon: e }) => (null != e && e.length ? e : null),
        gradient: ({ gradient: e }) => e.split(",").map((e) => e.trim(" ")),
      };
    (t.createBadgeFromInputs = ({
      inputMap: e = f,
      inputFixes: t = d,
      outputName: n = "badge",
    } = {}) => {
      try {
        const r = Object.entries(e).reduce(
          (e, [t, n]) => ({ ...e, [t]: u.getInput(n) }),
          {}
        );
        console.log("Received inputs:", r);
        for (const [e, n] of Object.entries(t)) r[e] = n(r);
        console.log("Generate badge using the given inputs and defaults:", r);
        const { path: i, ...o } = r,
          s = l.default(o);
        null != n &&
          n.length &&
          ...
          null != i &&
            ...
            c.default.writeFileSync(i, s),
            console.log("Data saved succesfully."));
      } catch (e) {
        console.error(e), u.setFailed(e.message);
      }
    }),
      (t.defaultInputFixes = d),
      (t.defaultInputMap = f);
  },
  393: function (e, t, n) {
    const { badgen: r } = n(295);
    const i = n(207);
    const o = (e, t, n) => {
      let r =
        '  <linearGradient id="' + n + '" x1="0%" y1="0%" x2="100%" y2="0%">';
      for (let e = 0; e < t.length; e++) {
        const n = Math.round((100 * e) / (t.length - 1));
        const o = i[t[e]] || t[e];
        r += `\n    <stop offset="${n}%" style="stop-color:#${o}" />`;
      }
      r += "\n  </linearGradient>\n</svg>";
      return e
        .replace("</svg>", r)
    ...
    e.exports = (e) => {
      if (!Array.isArray(e.gradient) || e.gradient.length === 0) {
        return r(e);
      }
      if (e.gradient.length === 1) {
        e.color = e.gradient[0];
        return r(e);
      }
      return s(o(r(e), e.gradient, "x"), "url(#x)");
    };
    e.exports.applyGradient = (e, t) => {
  ...
  470: function (e, t, n) {
    ...
    function exportVariable(e, t) {
      ...
      if (r) {
        ...
        const r = `${e}<<${t}${c.EOL}${n}${c.EOL}${t}`;
        u.issueCommand("ENV", r);
      } else {
